...
class AIVoiceAgent:
    ...
    # Generates a response using Gemini AI and converts it to speech
    def _generate_response(self, transcript):
        try:
            ...
            messages = [msg["content"] for msg in self.transcript]
            ...
            # Convert response to speech using your preferred TTS method
            # You can implement your preferred text-to-speech solution here
            
        except Exception as e:
            print(f"Error generating response: {e}")
            
    # Plays the audio from the given audio file
